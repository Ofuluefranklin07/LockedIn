...
export default function AuthPage({ type }: AuthPageProps) {
  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white flex items-center justify-center p-4 sm:p-6 md:p-10 font-sans relative overflow-hidden">
      <ThemeToggle className="absolute right-6 top-6 z-20" />

      <motion.div 
        initial={{ opacity: 0, scale: 0.95 }}
        animate={{ opacity: 1, scale: 1 }}
        className="w-full max-w-6xl bg-[#0A0A0A] border border-[#222] rounded-lg relative z-10 overflow-hidden lg:grid lg:grid-cols-[minmax(0,0.9fr)_minmax(420px,560px)]"
      >
        ...
        <div className="p-6 sm:p-8 md:p-12 xl:p-16">
          <div className={type === 'login' ? 'mb-8' : 'mb-12'}>
            ...
            {type === 'signup' && (
              <>
                <h2 className="text-xl sm:text-2xl md:text-3xl font-display font-bold uppercase tracking-tight break-words">
